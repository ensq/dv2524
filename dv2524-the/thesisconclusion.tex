...
% The chess benchmark has, as it set out to do, confirmed past suspicion of a bottleneck existant in the paravirtualization of large amounts of OpenGL invocations.

% The Julia benchmark has showcased radical performance improvements of paravirtualized graphics kernels in relation to software rasterization. This is testimonial to the performance gains aquired by means of paravirtualization in accordance to previous work by Lager-Cavilla.
