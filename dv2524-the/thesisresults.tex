...
We may deduce, albeit with regard to the less reliable results, that individual invocations of \dvttermmagicinstruction s could perform in line with the data presented in figure \ref{fig:histogrammagicinstructionsforeach} and table \ref{tab:magicinstructionsforeach} - in worst case scenario.
