...
However, due to the inhererent performance demands brought on by serialization of real-time graphics invocations, the methodology of \dvttermmagicinstruction s were selected for use for the purpose of this study (see section \dvtcmdrefname{sec:appendixa_magicinstructions} under \dvtcmdrefname{cha:appendixa} for an elaboration on \dvttermmagicinstruction s).
