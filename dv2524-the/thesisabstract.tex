...
\newline
\textbf{Objectives}.
This dissertation concerns the implementation of graphics acceleration by the means of paravirtualizing \dvttermopenglestwopointo\ in the \dvttermsimics\ full-system simulator.
Furthermore, this study illustrates the benefits and drawbacks of paravirtualized methodology, in addition to performance analysis and comparison with the \dvttermandroidemulator ; which likewise utilize paravirtualization to accelerate simulated graphics.
\newline
\textbf{Methods}. % Mention implementation
In this study, we propose a solution for paravirtualized graphics using \dvttermmagicinstruction s; the implementation of which is subsequently described.
...
\newline
\textbf{Results.}
For the purpose of this experiment, elapsed frame times for respective benchmarks are collected and compared with four platforms; i.e. the hardware accelerated \dvttermhost\ machine, the paravirtualized \dvttermandroidemulator , the software rasterized \dvttermsimics - and the paravirtualized \dvttermsimics\ platforms.
\newline
\textbf{Conclusions}.
