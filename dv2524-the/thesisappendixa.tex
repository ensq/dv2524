...
% Simics
% This section ought to oughtline the background, abilities, intentions, applications, and employers of the Simics full-system simulator.
\section*{Simics}
\label{sec:appendixa_simics}
\addcontentsline{toc}{section}{Simics}
\index{The Simics full-system simulator}
