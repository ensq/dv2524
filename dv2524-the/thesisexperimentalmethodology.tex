...
Furthermore, the study profiles the performance of the \dvttermandroidemulator\ for good measure, in addition to execution on the hardware accelerated \dvttermhost\ platform as a reference case.
