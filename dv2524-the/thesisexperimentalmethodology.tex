...
Furthermore, the experiment profiles the performance of the \dvttermandroidemulator\ for good measure, in addition to the performance of the original execution on the hardware accelerated \dvttermhost\ platform.
...
% TODO: Describe how the benchmark is written in Java, C, and GLSL, Resolution of experiment and other common factors
