...
Using these methods, one ought be able to retrieve the entirety of the \dvttermopengl\ state variables present in the \dvttermhost\ system (see \dvtcmdcitefur{technicaldocs:silicongraphics:2014} for more information on the \dvtcmdcodeinline{glGet}-family of methods).
...
% Having analyzed the addition of valued simics attributes
% There is no clear obstacle as to why performance ought be severly impaired by the introduction of said 
