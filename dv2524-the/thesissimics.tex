...
For these purposes, the simulator utilizes \dvttermdirectvirtualization , and other performance boosting technologies such as \dvttermhypersimulation ~\dvtcmdcitebib[p.~38]{publications:leupers:2010}.
Simics also features a number of advanced functionalities, adhering to the deterministic nature of the simulator, such as \dvttermcheckpointing\ (see section \dvtcmdrefname{sec:simics_checkpointing}) and \dvttermreverseexecution\ (see section \dvtcmdrefname{sec:simics_reverseexecution})~\dvtcmdcitebib{publications:leupers:2010}.
...
Current employers of the \dvttermsimics\ full-system simulator include \dvttermibm ~\dvtcmdcitebib[p.~12:1,~12:6]{journals:koerner:2009}, \dvttermnasa ~\dvtcmdciteref{web:windriver:2014}\dvtcmdciteref{web:nasa:2014}, and \dvttermintel ~\dvtcmdcitebib[p.~100]{journals:veselyi:2013}.
...
As such, throughout this document and in relation to the \dvttermsimics\ full-system simulator, \dvttermcheckpointing\ denotes this functionality.
...
In \dvttermsimics , '\dvttermreverseexecution ' denotes said ability - spanning the entirety of the simulated system~\dvtcmdcitebib[p.~30,~31]{publications:leupers:2010}.
