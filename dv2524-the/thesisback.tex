...
{\small This document was compiled in \releasebuildtostring\ \today\ and last edited by \gitAuthorName\ \gitAuthorDate . This document is Version.\gitVtagn , and can be identified using revision- and commit hash \href{\commitlink}{\texttt{\gitAbbrevHash}}}. % Consider inserting references string: \gitReferences\
\end{tabular}
