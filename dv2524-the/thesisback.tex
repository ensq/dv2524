...
{\small This document was compiled in \releasebuildtostring\ \today\ and last edited by \gitAuthorName\ \gitAuthorDate . This document may be identified using revision- and commit hash \href{\commitlink}{\texttt{\gitAbbrevHash}}}.
\end{tabular}
