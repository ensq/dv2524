...
In line with previous work in the area specified in chapter \ref{cha:relatedwork}, there has been no indication - in academic writing - of any pre-existing solution of paravirtualized graphics \dvttermapi s signifying support for advanced functionality such as \glslink{dvtglossdeterministicexecution}{deterministic} behaviour, \dvttermreverseexecution , or the ability to store and restore the state of a simulation.
