...
The direct contact with \dvttermhost\ system devices accomodated by methodologies such as \dvttermpcipassthrough\ enable hardware accelerated graphics.
...
Additionally, virtualizing at the graphics library software level circumvents the need for users to relink or modify the application they wish accelerated.
