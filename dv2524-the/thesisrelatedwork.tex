...
\noindent
For the purposes of graphics acceleration, there are number of strategies, methodologies and procedures (several of these are expanded upon in chapter \ref{cha:methodologysolution}).
...
In addition to this, \dvttermgoogle\ implemented \dvttermopengles\ \dvtcmdnum{1.1} \& \dvtcmdnum{2.0} hardware acceleration; offering a substantial performance boost to developers utilizing the \dvttermopengles\ frameworks\dvtcmdciteref{web:ducrohet:2012:afasteremulator}.
