...
Additionally, \dvttermqemu\ powers the \dvttermandroidemulator , which helps mobile developers bring about software for the \dvttermandroid\ \dvttermos\ (see paragraph \dvtcmdrefname{par:relatedwork_qemu_androidemulator} for an elaboration on the \dvttermandroidemulator ).
