...
The 'Phong' benchmark is developed for the purposes of stressing the throughput, or bandwidth - if adhering to the networking paradigm presented in paragraph \dvtcmdrefname{par:methodology_experimentmethodology_benchmarkchess}, in-between \dvttermtarget - and \dvttermhost\ systems.
