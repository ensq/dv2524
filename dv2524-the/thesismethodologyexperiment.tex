...
The experiment devised for the purpose of this dissertation is performed on the platforms outline in \dvtcmdcitefur{dissertation:nilsson:2014}; being software rasterized- and paravirtualized \dvttermsimics , respectively.
...
% TODO:
% Full hardware configuration outline
% Operating system
...
% Android 4.4
% Fedora 19
% Software rasterizer and drivers

%For the purposes of this study, the \dvttermfedora\ \dvttermlinux\ distribution has been selected for use due to \dvttermfedora\ being the 	primary platform used for development of the \dvttermsimics\ full-system simulator at the \dvttermintel\ offices in Stockholm.
%In line with \dvttermfedora\ being the \dvttermos\ in use when performing the reference benchmark experiments on the \dvttermhost\ platform, it may be of value to have the simulated \dvttermtarget\ machine configured to run with the same \dvttermos .
...
% Describe hardware configuration of the target machines (including android)
