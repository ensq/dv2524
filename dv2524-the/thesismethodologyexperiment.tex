...
% Experiment relevant data, such as number of frames gathered per benchmark, resolution of demo etc.
% The key value variations of each benchmark, with each key value described in tables, deserve it's own section.
...
In order to ensure responsivity in time critical profiling of elapsed time, we ensure said serial console is flushed to, by the means of performing the system call \dvtcmdcodeinline{tcdrain}.
...
Collected profiling overhead data is visualized in figure \todo{Refer to figure.} ...\todo{If collected benchmarking data has been modified with this overhead, this should be made apperent in this section.}

% TODO: Insert visualization of the profiling overhead.
\missingfigure[figwidth=6cm]{Profiling overhead figure.}
...
% TODO: Preferably the benchmark images ought to be presented side-by-side, as to not take up too much space (remember, not vector graphics goodies).
 % TODO: Insert image of benchmark output.
\missingfigure[figwidth=6cm]{Side-by-side image of Chess benchmark output.}
% TODO: Insert image of benchmark output.
\missingfigure[figwidth=6cm]{Side-by-side image of Chess benchmark output.}
% TODO: Insert image of benchmark output.
\missingfigure[figwidth=6cm]{Side-by-side image of Chess benchmark output.}
...
% Expand upon how such changes were made to investigate into solution scaling.
