...
In the presence of of the complexities caused by the occurence of virtual time (see section \dvtcmdrefname{sec:appendixa_virtualtime} under \dvtcmdrefname{cha:appendixa}), profiling of elapsed time in virtual platforms sometimes dictate special measures.
In \dvttermsimics , as described by section \dvtcmdrefname{sec:appendixa_virtualtime} under \dvtcmdrefname{cha:appendixa}, 
