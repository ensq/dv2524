...
In a \dvttermsimics\ simulation, as described by section \dvtcmdrefname{sec:background_virtualtime}, time increments differently than in the context of the \dvttermhost\ machine.
...
\input{tabkeyvalsmagicinstructions}
