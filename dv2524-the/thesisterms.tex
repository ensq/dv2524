...
{
  name=Checkpointing,
  description={See section \dvtcmdrefname{sec:appendixa_checkpointing} under chapter \dvtcmdrefname{cha:appendixa}}
}
...
\newglossaryentry{dvtglossdeterministicexecution}
{
  ...
  description={See section \nameref{sec:appendixa_deterministicexecution} under chapter \nameref{cha:appendixa}}
}
...
\newglossaryentry{dvtglossreverseexecution}
{
  ...
  description={See section \nameref{sec:appendixa_reverseexecution} under chapter \nameref{cha:appendixa}}
}
...
\newglossaryentry{dvtglosssimics}
{
  ...
  description={See section \dvtcmdrefname{sec:appendixa_simics} under chapter \dvtcmdrefname{cha:appendixa}}
}
\newcommand{\dvttermsimics}{\glslink{dvtglosssimics}{Simics}}
% SICS
\newacronym{dvtglosssics}{SICS}{The Swedish Institute of Computer Science}
