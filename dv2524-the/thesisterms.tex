...
{
  name=Checkpointing,
  description={See section \dvtcmdrefname{sec:background_checkpointing} under chapter \dvtcmdrefname{cha:appendixa}}
}
...
\newglossaryentry{dvtglossreverseexecution}
{
  ...
  description={See section \nameref{sec:background_reverseexecution} under chapter \nameref{cha:appendixa}}
}
...
\newglossaryentry{dvtglossreferencesolution}
{
  ...
  description={See section \dvtcmdrefname{sec:appendixa_referencesolution} under \dvtcmdrefname{cha:appendixa}}
}
...
\newglossaryentry{dvtglosssimics}
{
  ...
  description={See section \dvtcmdrefname{sec:background_simics} under chapter \dvtcmdrefname{cha:appendixa}}
}
