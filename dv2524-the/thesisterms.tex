...
% Checkpoint / Restart
\newcommand{\dvttermcheckpointrestart}{\dvtcmdcaponce{dvtglosscheckpointrestart}{Checkpoint / Restart}}
...
\newglossaryentry{dvtglossdeterministicexecution}
{
  ...
  description={See section \ref{sec:simics_deterministicexecution}}
}
...
\newcommand{\dvttermgpu}{\glslink{dvtglossgpu}{GPU}}
...
\newglossaryentry{dvtglosshost}
{
  ...
  description={A system on which a virtual platform is run}
}
...
\newglossaryentry{dvtglossmagicinstruction}
{
  ...
  description={See section \ref{sec:backgroundandrelatedwork_magicinstructions}},
}
...
\newglossaryentry{dvtglosstiming}
{
  ...
  description={Time intervals when state changes in a simulated system occur}
}
...
\newglossaryentry{dvtglosstarget}
{
  ...
  description={A simulated system}
}
