...
&\multirow{4}{*}{\includegraphics[trim = 3mm 0mm 3mm 4.7cm, clip, width=\logossize]{bthnotext}}\\ % Hack, but at least it's less of a hack than the previous solution of a misplaced, hard-coded, logo.
