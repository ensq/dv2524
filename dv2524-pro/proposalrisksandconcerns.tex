...
As such, considering that the experiment outlined in \dvcmdrefcha{cha:researchmethodology} denotes performance comparison to the \termrefsolu , it would be accurate if the paravirtualized solution in \termsimics\ was likewise implemented on the \termandroid\ platform.
