...
{\small This document was compiled in \buildconfig\ \today\ and last edited by \gitAuthorName\ \gitAuthorDate . This document is Version.\gitVtagn , and can be identified using revision- and commit hash \href{\commitlink}{\gitAbbrevHash}}. % \gitReferences\
\end{tabular}
