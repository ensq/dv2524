% dv2524packages.tex
% Specifies common packages. Note that there are additional, and conditional, packages that are not specified in this file.
...
\usepackage{multirow}
\usepackage{mfirstuc} % Used to uppercase the first character of text sets in dv2524commands.tex.
\usepackage{textcomp}
\usepackage{graphicx}
